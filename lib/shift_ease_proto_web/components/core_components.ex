defmodule ShiftEaseProtoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShiftEaseProtoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShiftEaseProtoWeb.Gettext, "errors", msg, opts)
    end
  end
